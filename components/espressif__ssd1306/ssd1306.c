...
void ssd1306_draw_line(ssd1306_handle_t dev, int16_t chXpos1, int16_t chYpos1, int16_t chXpos2, int16_t chYpos2, int8_t color)
{
    ...
    if (y_len < x_len) {
        ...
        do {
            ...
            diff += y_len;
            ssd1306_fill_point(dev, chXpos1++, chYpos1, color);
        } while (len--);
    }
